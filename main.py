...
list1 = set(plates_list)

number = input("Enter number: ")

if str.upper(number) in plates_list:
    print("Number exist")
else:
    print("No number in the list")

print("Number of unique numbers in list", len(list1))

from HW import func_1, func_2

print(func_1(number))
print("sum of digits in number=", func_2(number))
